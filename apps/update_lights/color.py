"""Color util methods from Home Assistant Core."""
...
def _get_red(temperature: float) -> float:
    ...
    if temperature <= 66:
        return 255
    tmp_red = 329.698727446 * math.pow(temperature - 60, -0.1332047592) + 50
...
def _get_green(temperature: float) -> float:
    ...
    if temperature <= 66:
        ...
        green = 288.1221695283 * math.pow(temperature - 60, -0.0755148492) + 50
    return _clamp(green)
